...
/*
	...
	- LocalDate(날짜), LocalTime(시간), LocalDateTime(날짜,시간), ZonedDateTime(지역) 클래스 포함
...
public class B_Time {
	...
	*/
	public void method1() {
		...
		System.out.println(now.getMonth() + "월"); // JUNE
		...
		// 날짜 조작
		LocalDateTime plusDay = now.plusDays(1).plusMonths(2).plusYears(3);
	...
	*/
	public void method2() {
		...
		System.out.println("minute : " + du.toMinutesPart()); // Part가 없으면 전체 차이분
