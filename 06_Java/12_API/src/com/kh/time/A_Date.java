...
public class A_Date {
	...
	public void method1() {
		...
		Date today = new Date();
		System.out.println(today); // Fri Jun 27 15:32:53 KST 2025
		
		Date when = new Date(0);
		System.out.println(when); // Thu Jan 01 09:00:00 KST 1970
		
		System.out.println("getTime : " + today.getTime()); // 1751006133931 밀리초
		
		System.out.println("getYear : " + (today.getYear() + 1900) + "년"); // 125 + 1900 = 2025년
		System.out.println("getMonth : " + (today.getMonth() + 1) + "월"); // 0부터 시작 -> + 1
		...
		// SimpleDateFormat : 날짜 데이터를 원하는 형태로 출력
		// 2025년 6월 27일 (금) 오후 3시 40분 0초 (HH -> 0 ~ 23, hh -> 1 ~ 12)
