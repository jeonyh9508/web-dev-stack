...
public class A_String {
	...
	*/
	...
	public void method2() {
		...
		String str2 = str.concat(" !  ! ").concat(str);
		...
		//		- 문자열의 beginIndex부터 endIndex - 1 까지 (endIndex 생략하면 끝까지)의 문자열을 새로 생성해 리턴
		...
		//		- 전달받은 str의 시작 인덱스를 리턴 (포함되어 있지않으면 -1)
		int index = str.indexOf("!");
		System.out.println(index);
		
		int index2 = str.indexOf("Java");
		System.out.println(index2); // 문자열 첫번째 값
		
		int index3 = str.indexOf("?");
		System.out.println(index3); // 포함 X
	...
	/*
		...
		- 가변 클래스
		- 16개의 문자를 저장할 수 있는 버퍼가 미리 생성되고 문자가 저장됨에 따라 자동증가
		- StringBuilder : 동기화 X -> 단일 스레드 환경 권장
		- StringBuffer : 동기화 O -> 멀티 스레디 환경 권장
	*/
	public void method3() {
		...
		// IPA avaJ
		sb2.delete(5,sb2.length()).append("API").reverse();
	...
	*/
	public void method4() {
		...
		//		- 압력받은 구분자로 문자열을 분리해서 문자열의 배열로 담아서 리턴
