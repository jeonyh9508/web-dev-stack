...
public class A_Variable {
	...
	*/
	...
	public static void main(String[] args) {
		...
		// 실행할 메서드가 있는 클래스 생성 (new) -> 본인이어도 클래스 생성이 필요
...
//		variable.variableTest();
	...
	public void variableTest() {
		/*
			...
			자료형 변수명;
			- 자료형 : 어떤 값을 저장할지, 어떤 크기의 메모르릴 할당받을 지에 대한 정보
...
//		2. 문자형 : 2byte = 16bit
		char ch = 'a';		// char 변수명 = 한글자; ch = 'ab' -> 에러
		
//		3. 정수형
		byte bNum = 1;				// 1byte (8bit) => 2^8 = 256 -(128 ~ 127)
//			 bNum =128; -> 오버플로우 (overflow) 에러
		short sNum = 128;			// 2byte (16bit) => 2^16
		int iNum = 922337283;		// 4btye (32bit) => 2^32 (기본)
		long lNum = 922337283458L;  // 8byte (64bit) => 2^64 - 숫자 뒤에 L(ㅣ)을 입력
...
//		 - 실제 데이터 값은 힙 메모리에 저장하고, 스택 메모리 변수 공간에는 실제 변수값이 저장된 힙 메모리의 위치값 저장
		String name = "이진용";
