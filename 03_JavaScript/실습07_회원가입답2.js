...
fields.forEach(({ id, exp, message }) => {
  ...
  input.addEventListener("input", (e) => {
    if (
      ...
      /*exp !== undefined &&*/ regExp?.test(e.target.value) // 논리연산자 우선순위 && > ||
      //? : nullsafety = null이 아닐때만 처리. 자바스크립트에선 undefined도 처리
    ) {
      span.innerHTML = "OK!";
    ...
    // signup.disabled = !fields.every((fields) => fields.check === true);
  });
});
