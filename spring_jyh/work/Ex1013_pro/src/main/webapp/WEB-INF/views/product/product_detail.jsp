		...
		if( xhr.readyState == 4 && xhr.status == 200 ){
			...
			if( json[0].result == 'yes' ){
				...
				if ( confirm("장바구니로 이동하시겠습니까?") ) {
					location.href = "cart_list.do?m_idx=" + ${sessionScope.member_idx}; 
				}
			} else {
...
<input type="hidden" name="m_idx" value="${member}">
<table border="1" align="center" width="600">
			...
			<tr>
				<td colspan="2" align="center"> 
					<input type="button" value="장바구니에 담기" onClick="addCart('${vo.idx}','${sessionScope.member_idx}')" />
					<input type="button" value="장바구니 보기" onClick="location.href='cart_list.do?m_idx=${sessionScope.member_idx}'" />
