...
INSERT INTO EMP_DML VALUES (100, '이승민', '서비스 개발팀', DEFAULT);

-- 모든 컬럼 값을 지정하지 않아서 에러
INSERT INTO EMP_DML VALUES (200, '박기민', '개발 지원팀');
-- 에러는 발생하지 않지만 데이터가 잘못 저장
INSERT INTO EMP_DML VALUES (300, '디자인팀', '성예찬', SYSDATE);
-- 컬럼 순서와 데이터 타입이 맞지 않아 에러
INSERT INTO EMP_DML VALUES ('기획팀', 400, '이상엽', DEFAULT);

INSERT INTO EMP_DML(EMP_ID, EMP_NAME, DEPT_TITLE, HIRE_DATE) VALUES(500, '조규상', '마케팅팀', NULL);

INSERT INTO EMP_DML(EMP_NAME, EMP_ID, DEPT_TITLE) VALUES ('최다인', 600, '인사팀'); 
-- EMP_NAME 컬럼에 NOT NULL 제약조건에 의해 에러
INSERT INTO EMP_DML(EMP_ID, DEPT_TITLE) VALUES (700, '보안팀');

INSERT INTO EMP_DML (
    SELECT EMP_ID, EMP_NAME, DEPT_TITLE, HIRE_DATE -- 순서랑 개수 주의
    FROM EMPLOYEE
...
INSERT ALL
    INTO EMP_DEPT(EMP_ID, EMP_NAME, DEPT_CODE, HIRE_DATE) VALUES(EMP_ID, EMP_NAME, DEPT_CODE, SYSDATE)
...
/*
    ...
    SET 
        컬럼명 = 변경하려는 값,
        컬럼명 = 변경하려는 값 ...
    WHERE 조건; -- WHERE 기본키(PRIMARY KEY) = 값;
