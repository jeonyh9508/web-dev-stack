...
import dao.MemberDAO;
	...
	/*
		...
		- 추상화된 클래스의 객체(구상객체, 실페 클래스)를 생성하고 반환받는 방법
...
//		System.out.println("RequestURI : " + requestURI); // RequestURI : /register.do
...
//		System.out.println("Command : " + command); // Command : register.do
